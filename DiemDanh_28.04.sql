...
--
-- Host: localhost
-- Generation Time: Apr 28, 2019 at 08:09 AM
...
(92, 6, NULL, NULL, NULL),
(93, 6, 1054030007, 1, NULL),
(94, 6, 1054030221, -1, 'Vang phep'),
(95, 6, 1054030244, -2, 'Vang khong phep~~~');
...
--
ALTER TABLE `tbl_chitietdiemdanh`
  MODIFY `MaChitietDiemdanh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `tbl_diemdanh`
  MODIFY `MaDiemDanh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
